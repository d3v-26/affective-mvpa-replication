function extract_betas_deepprep()
% Extract single-trial betas from SPM output (BetaS2_deepprep.m) into
% Pl#.mat, Nt#.mat, Up#.mat for SingleTrialDecodingv3.m
%
% BetaS2_deepprep.m creates one SPM model per subject with 5 sessions.
...
%% ===== CONFIG =====
beta_root = '/orange/ruogu.fang/pateld3/data/deepprep-betas';
out_dir   = '/orange/ruogu.fang/pateld3/data/deepprep-betas-extracted';
...
for s = 1:num_subjects
    ...
    beta_dir = fullfile(beta_root, sprintf('beta_series_sub-%03d', s));
